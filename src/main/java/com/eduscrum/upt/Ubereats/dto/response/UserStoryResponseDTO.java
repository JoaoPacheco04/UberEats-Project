...
public class UserStoryResponseDTO {
    ...
    public boolean isInReview() { return inReview; }
    public void setInReview(boolean inReview) { this.inReview = inReview; }
    ...
    public String getPriorityIcon() { return priorityIcon; }
    public void setPriorityIcon(String priorityIcon) { this.priorityIcon = priorityIcon; }
    ...
    public boolean isCanMoveToNextStatus() { return canMoveToNextStatus; }
    public void setCanMoveToNextStatus(boolean canMoveToNextStatus) { this.canMoveToNextStatus = canMoveToNextStatus; }

    public boolean isCanMoveToPreviousStatus() { return canMoveToPreviousStatus; }
    public void setCanMoveToPreviousStatus(boolean canMoveToPreviousStatus) { this.canMoveToPreviousStatus = canMoveToPreviousStatus; }
