...
public class ProgressMetricResponseDTO {
    private Long id;
    ...
    // Constructors
    public ProgressMetricResponseDTO() {}
    ...
    public BigDecimal getStoryPointsCompletion() { return storyPointsCompletion; }
    public void setStoryPointsCompletion(BigDecimal storyPointsCompletion) { this.storyPointsCompletion = storyPointsCompletion; }
    ...
    public BigDecimal getRemainingStoryPoints() { return remainingStoryPoints; }
    public void setRemainingStoryPoints(BigDecimal remainingStoryPoints) { this.remainingStoryPoints = remainingStoryPoints; }

    public boolean isOnTrack() { return onTrack; }
    public void setOnTrack(boolean onTrack) { this.onTrack = onTrack; }

    public boolean isAllTasksCompleted() { return allTasksCompleted; }
    public void setAllTasksCompleted(boolean allTasksCompleted) { this.allTasksCompleted = allTasksCompleted; }

    public boolean isAllStoryPointsCompleted() { return allStoryPointsCompleted; }
    public void setAllStoryPointsCompleted(boolean allStoryPointsCompleted) { this.allStoryPointsCompleted = allStoryPointsCompleted; }
    ...
    public Map<String, Integer> getBurnDownDataMap() { return burnDownDataMap; }
    public void setBurnDownDataMap(Map<String, Integer> burnDownDataMap) { this.burnDownDataMap = burnDownDataMap; }
